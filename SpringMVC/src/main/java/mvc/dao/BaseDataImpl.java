...
@Repository
public class BaseDataImpl implements BaseDataDao{
	...
	public Education getEducationById(Integer id) {
		return jdbcTemplate.queryForObject(queryAllSQL, new BeanPropertyRowMapper<>(Education.class),"Education",id);
	}
	@Override
	public List<Gender> findAllGenderes() {
	...
	public Gender getGenderById(Integer id) {
		return jdbcTemplate.queryForObject(queryAllSQL, new BeanPropertyRowMapper<>(Gender.class),"Gender",id);
	}
	@Override
	...
	public Interest getInterestById(Integer id) {
		return jdbcTemplate.queryForObject(queryAllSQL, new BeanPropertyRowMapper<>(Interest.class),"Interest",id);
	}
	@Override
	...
	@Override
	public int deleteInterestByUserId(Integer userId) {
