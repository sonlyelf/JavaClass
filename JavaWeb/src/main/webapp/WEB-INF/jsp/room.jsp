			...
			<tbody>
				<c:forEach items="${rooms}" var="room">
					<tr>
						...
						<td>${room.roomName}</td>
						<td>
							<a href="/JavaWeb/room/update?roomId=${room.roomId}" class="pure-button button-secondary">編輯</a>
						</td>
						<td>
							<a href="/JavaWeb/room?deleteId=${room.roomId}" class="pure-button button-error">刪除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
