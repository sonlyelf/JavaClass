			...
			<tbody>
				<c:forEach items="${bookingRoomDtos}" var="bookingRoomDto">
					<tr>
						...
						<td><a href="/JavaWeb/bookingroom/update?roomId=${bookingRoomDto.bookingId}" class="pure-button button-secondary">編輯</a></td>
						<td><a href="/JavaWeb/bookingroom?deleteId=${bookingRoomDto.bookingId}" class="pure-button button-warning ">刪除</a></td>
					</tr>
				</c:forEach>
